...
describe("Cart", function() {
    ...
    it("increasing item quantity in cart should be successful", function() {
        ...
        $(".btn.btn-success").click();  //click add to cart
        browser.pause(1500);
        let quantity = Number($("#cart").getAttribute("span.quantity"));
        ...
        $(".btn.btn-success").click();  //click add to cart
        browser.pause(1500);
        let quantity1 = Number($("#cart").getAttribute("span.quantity"));
    ...
    it("decreasing item quantity in cart should be successful", function() {
        ...
        browser.pause(1500);
        let quantity2 = Number($("#cart").getAttribute("span.quantity"))
  ...
  describe("Prices", function() {
    ...
    it("can be switched to EUR", function() {
        ...
        let defaltCurrency: string = $(".currency").getAttribute("span");
        ...
        let newCurrency: string =  $(".currency").getAttribute("span");
        console.log("new currency " + newCurrency);
        expect(defaltCurrency).to.contain("EUR");
    });
